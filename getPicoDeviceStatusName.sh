#!/bin/bash
# show device status
# usage: bash getPicoDeviceStatusName.sh <user> <passwd> <deviceId>
...
beername=`grep BeerName /tmp/pico_$1_status|cut -d'"' -f4`
lastevent=`grep Event /tmp/pico_$1_status|grep -v null|tail -1|cut -d'"' -f4`
if [ -z `grep "Event" /tmp/pico_$1_status` ]
  then
  echo "idle";
else
  echo $beername:$lastevent
fi
: '
idle
{
  ...
  "ActiveSession": {
    ...
    "GUID": "9999ef9e54e349f999d3d53fe6fa9999",
    "BeerGUID": null,
    "RecipeGUID": null,
...
busy
{
  ...
  "ActiveSession": {
    ...
    "BeerStyle": "Lite American Lager",
    "GUID": "12ea9cf123fa4fc9a12344de24c5c123",
    "BeerGUID": null,
    "RecipeGUID": null,
